        ...
        <Card className="aspect-square rounded-3xl" style={bgStyle} >
            <CardHeader>
                <CardTitle className="text-white antialiased md:subpixel-antialiased">
                    ...
                    {(gameData.artist_name1 || gameData.release_date) && (<div className="text-md bg-black bg-opacity-20 size-fit p-1 rounded-b-sm">{gameData.artist_name1} {gameData.release_date}</div>)}
                </CardTitle>
            </CardHeader>
